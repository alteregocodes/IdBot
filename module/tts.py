...
# Registrasi handler untuk perintah TTS (/tts)
...
# Registrasi handler untuk perintah setting bahasa TTS (/bahasatts)
...
# Registrasi handler untuk callback setting bahasa TTS
